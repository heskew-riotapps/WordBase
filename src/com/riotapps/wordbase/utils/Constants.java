...
public class Constants {
	...
	public static final String ACTIVITY_CLASS_FULL_RULES = "full_rules";
	public static final String ACTIVITY_CLASS_GAME_HISTORY = "game_history";
	public static final String ACTIVITY_CLASS_GAME_LOOKUP = "game_lookup";
	public static final String ACTIVITY_CLASS_GAME_SURFACE = "game_surface";
	public static final String ACTIVITY_CLASS_SPLASH = "splash";
	public static final String ACTIVITY_CLASS_STORE = "store";
